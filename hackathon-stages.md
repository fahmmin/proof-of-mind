...
💭 Idea Submission
In this task, submit a brief overview of the idea you plan to work on for Level 4.
This step helps us make sure your idea aligns with the Level 4-6 scope and expectations before you begin building.
﻿
Provided Idea List 
Private Voting — anonymous ballots with publicly verifiable tallies,
Age / Eligibility Gate — prove a threshold without revealing the underlying value,
